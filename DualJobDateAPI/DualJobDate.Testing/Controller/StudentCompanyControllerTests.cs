...
public class StudentCompanyControllerTests
{
    ...
    public async Task GetStudentCompanies_ReturnsListOfStudentCompanies()
    {
        ...
        var user = new User();
        var studentCompanies = new List<StudentCompany> { new() };
        var studentCompanyDtoList = new List<StudentCompanyDto> { new() };
    ...
    public async Task GetStudentCompanies_ReturnsListOfStudentCompaniesSortedByLikesAndDislikes()
    {
        ...
        var user = new User();
        var studentCompanies = new List<StudentCompany> { new(), new() };
        var studentCompanyDtoList = new List<StudentCompanyDto> { new(), new() };
